...
frame_name1 =tk.Label(frame1,text= 'ID Biljke: Biljka 01',bg='#282828',fg='white',font=('Arial', 10))
frame_name1.grid(column=1, row=2, padx=5, pady=5)

img1 = Image.open('slika_1.jpg')
resized1=img1.resize((100,70), Image.Resampling.LANCZOS)
...
frame_name2 =tk.Label(frame2,text= 'ID Biljke: Biljka 02',bg='#282828',fg='white',font=('Arial', 10))
frame_name2.grid(column=1, row=3, padx=5, pady=5)

img2 = Image.open('slika_2.jpg')
resized2=img2.resize((100,70), Image.Resampling.LANCZOS)
...
frame_name3 =tk.Label(frame3,text= 'ID Biljke: Biljka 03',bg='#282828',fg='white',font=('Arial', 10))
frame_name3.grid(column=1, row=4, padx=5, pady=5)

img3 = Image.open('slika_3.jpg')
resized3=img3.resize((100,70), Image.Resampling.LANCZOS)
...
frame_name4 =tk.Label(frame4,text= 'ID Biljke: Biljka 04',bg='#282828',fg='white',font=('Arial', 10))
frame_name4.grid(column=1, row=2, padx=5, pady=5)

img4 = Image.open('slika_4.jpg')
resized4=img4.resize((100,70), Image.Resampling.LANCZOS)
...
frame_name5 =tk.Label(frame5,text= 'ID Biljke: Biljka 05',bg='#282828',fg='white',font=('Arial', 10))
frame_name5.grid(column=1, row=3, padx=5, pady=5)

img5 = Image.open('slika_5.jpg')
resized5=img5.resize((100,70), Image.Resampling.LANCZOS)
...
frame_name6 =tk.Label(frame6,text= 'ID Biljke: Biljka 06',bg='#282828',fg='white',font=('Arial', 10))
frame_name6.grid(column=1, row=4, padx=5, pady=5)


img6 = Image.open('slika_6.jpg')
resized6=img6.resize((100,70), Image.Resampling.LANCZOS)
...
frame_name7 =tk.Label(frame7,text= 'ID Biljke: Biljka 07',bg='#282828',fg='white',font=('Arial', 10))
frame_name7.grid(column=1, row=2, padx=5, pady=5)


img7 = Image.open('slika_7.jpg')
resized7=img7.resize((100,70), Image.Resampling.LANCZOS)
...
frame_name8 =tk.Label(frame8,text= 'ID Biljke: Biljka 08',bg='#282828',fg='white',font=('Arial', 10))
frame_name8.grid(column=1, row=3, padx=5, pady=5)


img8 = Image.open('slika_8.jpg')
resized8=img8.resize((100,70), Image.Resampling.LANCZOS)
...
frame_name9 =tk.Label(frame9,text= 'ID Biljke: Biljka 09',bg='#282828',fg='white',font=('Arial', 10))
frame_name9.grid(column=1, row=10, padx=5, pady=5)


img9 = Image.open('slika_9.jpg')
resized9=img9.resize((100,70), Image.Resampling.LANCZOS)
...
frame_name10 =tk.Label(frame10,text= 'ID Biljke: Biljka 10',bg='#282828',fg='white',font=('Arial', 10))
frame_name10.grid(column=1, row=2, padx=5, pady=5)


img10 = Image.open('slika_10.jpg')
resized10=img10.resize((100,70), Image.Resampling.LANCZOS)
...
button11 = tk.Button(root, text='Dodaj novu biljku', 
   width=20,command = lambda:upload_file())
button11.grid(row=3,column=1,columnspan=4)
...
sync_image.grid( row=3, column=2, padx=5, pady=5)

moj_profil_image = tk.Button(root, text='Moj profil' ,bg='#282828', fg='white',font=('Arial', 10))
moj_profil_image.grid( row=3, column=3, padx=5, pady=5)
